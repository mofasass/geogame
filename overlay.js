...
function isInTriangle(pointsArray, x, y) {
	...
	var refX = pointsArray[0].x;
	var refY = pointsArray[0].y;
	var angleBoundary1 = segmentAngleRad(refX, refY, pointsArray[1].x, pointsArray[1].y, true);
	var angleBoundary2 = segmentAngleRad(refX, refY, pointsArray[2].x, pointsArray[2].y, true);
	...
	var refX = pointsArray[1].x;
	var refY = pointsArray[1].y;
	var angleBoundary1 = segmentAngleRad(refX, refY, pointsArray[2].x, pointsArray[2].y, true);
	var angleBoundary2 = segmentAngleRad(refX, refY, pointsArray[0].x, pointsArray[0].y, true);
	var anglePoint = segmentAngleRad(refX, refY, x, y, true);
 ...
 */
function overlay(pointsArray1, pointsArray2, precision) {
...
function overlayAnimated(pointsArray1, pointsArray2, precision, canvasID) {
	...
	// Triangles
	ctx.beginPath();
	ctx.moveTo(pointsArray1[0].x, pointsArray1[0].y);
	ctx.lineTo(pointsArray1[1].x, pointsArray1[1].y);
	ctx.lineTo(pointsArray1[2].x, pointsArray1[2].y);
	ctx.lineTo(pointsArray1[0].x, pointsArray1[0].y);
	
	ctx.moveTo(pointsArray2[0].x, pointsArray2[0].y);
	ctx.lineTo(pointsArray2[1].x, pointsArray2[1].y);
	ctx.lineTo(pointsArray2[2].x, pointsArray2[2].y);
	ctx.lineTo(pointsArray2[0].x, pointsArray2[0].y);
